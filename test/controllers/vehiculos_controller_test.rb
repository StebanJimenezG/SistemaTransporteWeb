...
class VehiculosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vehiculo" do
    assert_difference('Vehiculo.count') do
      post vehiculos_url, params: { vehiculo: { modelo: @vehiculo.modelo, pasajero_id: @vehiculo.pasajero_id, recorrido_id: @vehiculo.recorrido_id } }
    end
  ...
  test "should update vehiculo" do
    patch vehiculo_url(@vehiculo), params: { vehiculo: { modelo: @vehiculo.modelo, pasajero_id: @vehiculo.pasajero_id, recorrido_id: @vehiculo.recorrido_id } }
